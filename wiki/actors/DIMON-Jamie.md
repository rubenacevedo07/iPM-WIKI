...
related_institutions: [jpmorgan]
related_commodities: []
related_themes: [global-liquidity, financial-stability, us-debt]
db_id: 12
db_type: PERSON
---
...
## Summary
CEO of JPMorgan Chase. FINANCIAL archetype. DB ID: 12 (same as JPMorgan company ID). PersonPowerIndex not yet seeded. Highest EdgeRiskScore actor in current graph — Dimon→USA edge has 9 open timelines (highest in platform). Financial map timelines pending (CL-002).

## Role and Levers
Runs the largest US bank by assets. Annual shareholder letter shapes financial
stability and geopolitical risk narrative. JPMorgan's trading and lending desk
positions give real-time macro signal. Fed stress test performance shapes capital
return capacity.
...
Annual letter → credit market positioning.

## Oracle Relevance
- Tracked by: James Okafor (US markets/earnings), Elena Sorokina (global liquidity/credit)

## DB Sync Notes
- PersonPowerIndex: NOT YET SEEDED
- GraphEdgeWithTimelines: Dimon→USA = 9 open timelines (top in entire graph)
- Financial map timelines: PENDING (CL-002 IntelligenceOrder)
...
## Open Questions
- CL-002 execution date?
- What are the 9 open timelines on Dimon→USA edge?
