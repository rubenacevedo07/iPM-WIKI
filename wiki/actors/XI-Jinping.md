...
related_countries: [china, russia, taiwan]
related_institutions: [pboc, pla]
related_commodities: [semiconductors, rare-earths, oil]
related_themes: [tech-decoupling, trade-war, taiwan-strait, de-dollarization]
db_id: 171
db_type: PERSON
---
...
## Summary
General Secretary of the CCP, President of the PRC, Chairman of the Central Military Commission. HYBRID archetype — combines political, coercive, and industrial power. PersonPowerIndex composite: 79. IdeologyProfile pending seed.

## Role and Levers
Full-spectrum control over CCP, PLA, PBOC (indirect), state enterprises. Drives Belt
and Road, tech self-sufficiency (Made in China 2025), Taiwan reunification timeline,
and BRICS+ de-dollarization agenda.
...
Trade war → global supply chain → EM FX, industrial metals.

## Oracle Relevance
- Primary machines: Chen Wei (Asia/semiconductors/Taiwan), Mei Lin Zhang (China/trade war)
...
| EnvScore | -3.0 | |
| ReligionScore | -5.0 | |
| **Label** | **CCP nationalist authoritarian** | Confidence: 80/100 |

**Key divergence:** Trump (GeoScore −4.0 vs +3.0 = 7.0 gap; AuthScore both high but different system)
*Source: Knowledge-based scoring from public record · Pending Perplexity source verification*

## DB Sync Notes
- PersonPowerIndex: ✅ SEEDED (composite 79)
...
- PBOC reserve policy and gold accumulation rate?
